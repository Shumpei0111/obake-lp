// import Title from '../../assets/img/logo_tate.svg';
    ...
    class Glitch {
        ...
        shiftRGB(srcImg) {
            ...
            for (let y = 0; y < srcImg.height; y++) {
                for (let x = 0; x < srcImg.width; x++) {
                    let r, g, b, a;
                    let r2, g2, b2, a2;  // eslint-disable-line
                    let index;
        ...
        show() {          
            ...
            if (!this.throughFlag) {
                ...
                p.image(this.imgOrigin, 160, 480, this.imgOrigin.width/3, this.imgOrigin.height/3  );
                p.pop();
                return;
            }
            ...
            p.push();
            p.translate((p.width - this.imgOrigin.width) / 2, (p.height - this.imgOrigin.height) / 2);
            p.image(this.imgOrigin, 0, 0, this.imgOrigin.width/3, this.imgOrigin.height/3);
            p.pop();
            ...
            this.scatImgs.forEach((obj) => {
                ...
                if (obj.img) {
                    p.image(obj.img, obj.x, obj.y, this.imgOrigin.width/3, this.imgOrigin.height/3);
                }
                p.pop();
            })
