      ...
      <div className="plan__wrapper">
        <div className="plan__container">
          <Swiper
            ...
            slidesPerView={5}
            spaceBetween={10}
            className="plan__plan_box"
          >
            {days.map((d, ind) => (
              <SwiperSlide key={d.day}>
                <div onClick={() => setIsChoosed(d)}>
                  <div
                    className={`plan_box__item ${
                      isChoosed.id === d.id ? "isChoosed" : ""
                    }`}
                  >
                    <span className="plan_box__item_day">{d.day}</span>
                    <span className="plan_box__item_week">({d.week})</span>
                  </div>
                </div>
              </SwiperSlide>
            ))}
          ...
          <div className="plan__card">
            <div className="tour_detail common">
              ...
              <p className="plan__plan">
                <TourPlanTour />
              </p>
              <p
                className={`plan__plan_kind_wrapper ${
                  changed ? "changing" : ""
                }`}
              >
                <span className="plan__plan_kind ad">大人</span>
                {tourPriceAd}円
              </p>
              <p
                className={`plan__plan_kind_wrapper ${
              ...
              >
                <span className="plan__plan_kind ch">
                  子供<span className="ch_cap">(中学生以上)</span>
                </span>
                {tourPriceCh}円
              </p>
            </div>
