...
「実際の廃校を使ったお化け屋敷のサイト」という設定で LP を制作しました。

## 技術スタック

- **React 18** - モダンな React フレームワーク
- **Vite** - 高速なビルドツール
- **SCSS** - CSS プリプロセッサ
- **GSAP** - アニメーションライブラリ
...
SNS との連携も検討し、Twitter 上でクリアタイムをランキングで毎日発表するなどの施策しました。
...
- [予想されるターゲット]
  - 24 歳〜35 歳の車で移動することができる個人、グループまたは夫婦
...
**ランキングが発表され SNS で共有が可能であることを伝えるため**
